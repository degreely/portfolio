      ...
      <Section id="method-of-evaluation">
        <Container>
          <div>
            ...
            <p>
              All of our participants are students from the National University
              of Singapore (NUS) with the following key characteristics:
            </p>
            <ul>
              <li>
            ...
            <p>
              ...
              each to facilitate the test for. Tests were conducted remotely via
              the video-conferencing platform, Zoom, and participants were
              ...
              prepared ahead of time. Once the tasks were completed, we asked a
              series of questions for participants to reflect on their
                    ...
                    <Table>
                      ...
                      <TableBody lineWrap="padded" vAlign="middle">
                        <TableRow>
                          ...
                          <TableCell>Templates appear as rectangles</TableCell>
                          <TableCell>Templates appear as squares</TableCell>
                        </TableRow>
                        <TableRow>
                          ...
                          <TableCell>
                            <ul>
                              <li>
                                Click on the circle on the left to select
                              </li>
                              <li>
                                Click on the rectangle to view the modules in the template
                              </li>
                            </ul>
                          </TableCell>
                          <TableCell>
                            Since degree.ly is a platform for degree planning,
                            adding and removing modules from semesters as part
                            of the planning would be a critical task. This makes
                            performing usability tests for essential. At the
                            same time, we could verify the intuitivity of our
                            design by gauging participants’ understanding that
            ...
            <p>
              Once the A/B testing was completed, the facilitator asked several
              questions to get participants to reflect on their experience with
              our prototype.
            </p>
            <p>Questions asked:</p>
            <ul>
              ...
              <ul>
                ...
                <li>
                  The dashboard was helpful for me to understand what modules I
                  have not taken but need to before graduation
                </li>
                <li>
                ...
                <li>
                  I feel that I will use this platform in the future in place of
                  my current methods for degree planning
                </li>
              </ul>
            </ul>
          </div>
